...
export class CreateTable1714502618572 implements MigrationInterface {
  name = 'CreateTable1714502618572';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "urls" ("id" SERIAL NOT NULL, "original_url" character varying(255) NOT NULL, "short_url" character varying(30) NOT NULL, "clicks" integer, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP DEFAULT now(), "deleted_at" TIMESTAMP, "userId" integer, CONSTRAINT "REL_3088b58113241e3f5f6c10cf1f" UNIQUE ("userId"), CONSTRAINT "PK_eaf7bec915960b26aa4988d73b0" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
